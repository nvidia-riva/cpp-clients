...
class RealtimeClient : public WebSocketClientBase {
 ...
 public:
  ...
  // Public audio streaming methods for microphone input
  void SendAudioAppendPublic(const std::string& audioBase64);
  void SendAudioCommitPublic();
  void SendAudioDonePublic();
